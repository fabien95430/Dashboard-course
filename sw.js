const CACHE='courses-app-v42-ios-top-status-area';
const SHELL=['./welcome-cart-v28.webp','./welcome-background-v40.webp','./','./index.html','./styles.css?v=42','./catalog.js','./app.js?v=27','./manifest.webmanifest?v=42','./icon-premium-v40.svg','./icon.svg','./bring-photo-v4-frais.webp.png?v=14','./bring-photo-v4-fruits-legumes.webp.png?v=14','./bring-photo-v4-epicerie.webp.png?v=14','./bring-photo-v4-boissons.webp.png?v=14','./bring-photo-v4-maison.webp.png?v=14'];
