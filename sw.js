const CACHE='courses-app-v59-welcome-background-restored';
const SHELL=['./welcome-background-v48.webp?v=59','./welcome-cart-v48.webp','./','./index.html','./styles.css?v=59','./catalog.js','./app.js?v=27','./manifest.webmanifest?v=46','./icon-premium-v40.svg','./icon.svg','./bring-photo-v4-frais.webp.png?v=14','./bring-photo-v4-fruits-legumes.webp.png?v=14','./bring-photo-v4-epicerie.webp.png?v=14','./bring-photo-v4-boissons.webp.png?v=14','./bring-photo-v4-maison.webp.png?v=14'];
