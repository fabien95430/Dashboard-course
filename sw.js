const CACHE='courses-app-v34-premium-192-icon';
const SHELL=['./welcome-cart-v28.webp','./welcome-left-v28.webp','./welcome-right-v28.webp','./welcome-bottom-v28.webp','./','./index.html','./styles.css?v=33','./catalog.js','./app.js?v=27','./manifest.webmanifest?v=34','./icon-premium-192.png','./icon.svg','./bring-photo-v4-frais.webp.png?v=14','./bring-photo-v4-fruits-legumes.webp.png?v=14','./bring-photo-v4-epicerie.webp.png?v=14','./bring-photo-v4-boissons.webp.png?v=14','./bring-photo-v4-maison.webp.png?v=14'];
