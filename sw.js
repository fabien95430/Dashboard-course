...
const SHELL=['./','./index.html','./styles.css?v=26','./catalog.js','./app.js?v=26','./manifest.webmanifest','./apple-touch-icon.png','./icon-premium.png','./bring-photo-v4-frais.webp.png?v=14','./bring-photo-v4-fruits-legumes.webp.png?v=14','./bring-photo-v4-epicerie.webp.png?v=14','./bring-photo-v4-boissons.webp.png?v=14','./bring-photo-v4-maison.webp.png?v=14'];
