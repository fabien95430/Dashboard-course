const CACHE='courses-app-v47-premium-icon';
const SHELL=['./welcome-background-v40.webp','./','./index.html','./styles.css?v=46','./catalog.js','./app.js?v=27','./manifest.webmanifest?v=42','./icon-premium-v42.svg','./icon.svg','./bring-photo-v4-frais.webp.png?v=14','./bring-photo-v4-fruits-legumes.webp.png?v=14','./bring-photo-v4-epicerie.webp.png?v=14','./bring-photo-v4-boissons.webp.png?v=14','./bring-photo-v4-maison.webp.png?v=14'];
