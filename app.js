...
const CATALOG_DISPLAY_NAMES=Object.freeze({
  ...
  "Yaourts vanille":"Yaourts van.",
  "Yaourts fruits":"Yaourt fruits",
  "Petits-suisses":"Petit-suisse",
  "Crème dessert chocolat":"Crème choco.",
  "Crème dessert vanille":"Crème vanille",
  "Blanc de poulet":"Blanc poulet",
  "Escalopes de poulet":"Escalopes",
  "Pâtes fraîches":"Pâtes fraîch.",
  "Frites surgelées":"Frites surg.",
  "Légumes surgelés":"Légumes surg.",
  "Haricots verts surgelés":"Haricot surg.",
  "Petits pois surgelés":"Petits pois",
  "Poêlée de légumes":"Poêlée lég.",
  "Poisson surgelé":"Poisson surg.",
  "Steaks hachés surgelés":"Steaks surg.",
  "Pizza surgelée":"Pizza surg.",
  "Glace chocolat":"Glace choco.",
  "Pain aux céréales":"Pain céréales",
  "Pains au chocolat":"Pains choco.",
  "Galettes de blé":"Galettes blé",
  "Fruit de la passion":"Fruit passion",
  "Haricots verts":"Haricot vert",
  "Pommes de terre":"Pommes terre",
  "Patates douces":"Patate douce",
  "Oignons jaunes":"Oignon jaune",
  "Oignons rouges":"Oignon rouge",
  "Olives fraîches":"Olives",
  "Tomates pelées":"Tomate pelée",
  "Concentré de tomate":"Concentré tom",
  "Haricots rouges":"Haricot rouge",
  "Petits pois carottes":"Petits pois",
  "Champignons en boîte":"Champignons",
  "Raviolis en boîte":"Raviolis",
  "Sauce barbecue":"Sauce BBQ",
  "Vinaigre balsamique":"Vinaigre bal.",
  "Vinaigre de vin":"Vinaigre vin",
  "Huile de tournesol":"Huile tourn.",
  "Café en grains":"Café grains",
  "Chocolat en poudre":"Chocolat poud",
  "Flocons d'avoine":"Flocons av.",
  "Pâte à tartiner":"Pâte tartiner",
  "Biscuits chocolat":"Biscuits choc",
  "Biscuits beurre":"Biscuits beur",
  "Barres céréales":"Barres céré.",
  "Compotes gourdes":"Compotes",
  "Chocolat au lait":"Chocolat lait",
  "Levure chimique":"Levure chim.",
  "Levure boulangère":"Levure boul.",
  ...
  "Purée en flocons":"Purée",
  "Bouillon cubes":"Bouillon cub.",
  "Soupes en brique":"Soupes",
  "Eau aromatisée":"Eau arom.",
  "Jus multifruits":"Jus multifr.",
  "Lait chocolaté":"Lait choco.",
  "Sirop de grenadine":"Sirop grenad.",
  ...
  "Nettoyant salle de bain":"Nettoyant SDB",
  "Éponges magiques":"Éponges mag.",
  "Lingettes ménage":"Lingettes mén",
  "Lessive liquide":"Lessive liq.",
  "Lessive capsules":"Lessive caps.",
  "Lessive poudre":"Lessive poud.",
  "Lingettes anti-décoloration":"Lingette anti",
  "Filet de lavage":"Filet lavage",
  "Nettoyant machine à laver":"Nettoyant ML",
  "Désodorisant textile":"Désodorisant",
  "Pinces à linge":"Pince à linge",
  "Sacs linge délicat":"Sacs délicat",
  "Liquide vaisselle":"Liquide vaiss",
  "Tablettes lave-vaisselle":"Tablettes LV",
  "Sel lave-vaisselle":"Sel LV",
  "Liquide rinçage":"Liquide rinç.",
  "Nettoyant lave-vaisselle":"Nettoyant LV",
  "Brosses vaisselle":"Brosses vaiss",
  "Papier toilette":"Papier WC",
  "Serviettes papier":"Serviettes",
  "Papier aluminium":"Papier alu",
  "Film alimentaire":"Film aliment.",
  "Papier cuisson":"Papier cuis.",
  "Sacs poubelle 30L":"Sac poub. 30L",
  "Sacs poubelle 50L":"Sac poub. 50L",
  "Sacs congélation":"Sacs cong.",
  "Filtres aspirateur":"Filtres aspi.",
  "Après-shampoing":"Après-shamp.",
  "Brosses à dents":"Brosses dents",
  "Mouchoirs poche":"Mouchoirs p.",
  "Gel hydroalcoolique":"Gel hydro",
  "Papier toilette humide":"Papier WC hum",
  "Crème hydratante":"Crème hydra.",
  "Mousse à raser":"Mousse rasage",
  "Eau micellaire":"Eau micell.",
  "Protections hygiéniques":"Protections",
  "Thermomètre piles":"Thermomètre",
  "Lingettes bébé":"Lingette bébé",
  "Lait infantile":"Lait bébé",
  "Sacs à couches":"Sac à couches",
  "Croquettes chat":"Croquettes",
  "Croquettes chien":"Croquettes",
...
function sprite(product,compact=false){
  ...
  const safeTop=0;
  const safeLeft=0;
  const hasIsolatedAtlas=position.category==='Maison'||position.category==='Boissons'||position.category==='Épicerie'||position.category==='Fruits & Légumes';
